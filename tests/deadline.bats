...
@test "within 3w window, book Christmas delivery becomes imminent" {
    ...
    WHATNEXT_TODAY=2025-12-02 run --separate-stderr \
        whatnext \
            docs/deadlines.md
...
@test "within default 2w window, complete and release becomes imminent" {
    ...
    WHATNEXT_TODAY=2025-11-21 run --separate-stderr \
        whatnext \
            docs/deadlines.md
...
@test "past deadline, task becomes overdue" {
    WHATNEXT_TODAY=2025-12-06 run --separate-stderr \
        whatnext \
            docs/deadlines.md
...
@test "filter by medium priority" {
    WHATNEXT_TODAY=2025-12-24 run --separate-stderr \
        whatnext \
            --priority medium \
            docs/deadlines.md
